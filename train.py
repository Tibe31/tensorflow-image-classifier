...
for b in BATCH_SIZE:
    ...
    #salvo
    #model.save('modelli/%s'%b+'_%s'%INPUT_SHAPE[0]+'_%s'%INPUT_SHAPE[1]+'_%s'%INPUT_SHAPE[2]+'_%s'%today)
    plt.savefig('modelli/%s'%b+'_%s'%INPUT_SHAPE[0]+'_%s'%INPUT_SHAPE[1]+'_%s'%INPUT_SHAPE[2]+'.jpg')
