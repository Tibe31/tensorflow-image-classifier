...
data_dir = '/colony_dataset/'
Dataset_names_path = "model_data/colonies.txt"
Dataset_train = "model_data/colonies_train.txt"
Dataset_test = "model_data/colonies_test.txt"
is_subfolder = False
